...
public class Temperature extends JFrame implements ActionListener ,KeyListener{
	...
	private JLabel calculatorlbl,converterlbl;	private JButton b1;
	private JButton b2;
	private JButton b3;
	private JButton b4;
	private JButton b5;
	...
	public Temperature() {
		...
		buttonborder=BorderFactory.createLineBorder(Color.black,1);
		 activebuttonborder=BorderFactory.createLineBorder(howercolor,2);
			...
			combo1.setModel(new DefaultComboBoxModel(new String[] {"Celcius", "Fahrenhit", "Kelvin"}));
			...
			combo2.setModel(new DefaultComboBoxModel(new String[] {"Celcius", "Fahrenhit", "Kelvin"}));
	...
	public void docalc()
	{
		...
		if(firstm=="Celcius")
		{
			if(secondm=="Fahrenhit")
			{
				
				Double number=Double.parseDouble(l1.getText());
				number=(9*number)/5+32;
				l2.setText(number+"");
			}
			else if(secondm=="Kelvin")
			{

				Double number=Double.parseDouble(l1.getText());
				l2.setText(number+273.15+"");
			}
		}
		else if(firstm=="Fahrenhit")
		{
			if(secondm=="Celcius")
			{
		...
		else if(firstm=="Kelvin")
		{
			if(secondm=="Fahrenhit")
			{
				
				Double number=Double.parseDouble(l1.getText());
				number=((9*(number-273.15))/5+32);
				l2.setText(number+"");
			}
			else if(secondm=="Celcius")
			{
