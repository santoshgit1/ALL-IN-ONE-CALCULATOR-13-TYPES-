...
public class Frequency extends JFrame implements ActionListener , KeyListener
{
	...
	public Frequency() {
		...
		buttonborder=BorderFactory.createLineBorder(Color.black,1);
		 activebuttonborder=BorderFactory.createLineBorder(howercolor,2);
			...
			combo1.setModel(new DefaultComboBoxModel(new String[] {"Hertz", "Kilohertz", "Megahertz", "Gigahertz"}));
			...
			combo2.setModel(new DefaultComboBoxModel(new String[] {"Hertz", "Kilohertz", "Megahertz", "Gigahertz"}));
	...
	public void docalc()
	{
		...
		String secondm=(String) combo2.getSelectedItem();
			...
			if(firstm=="Hertz")
			{
				...
				else if(secondm=="Kilohertz")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1000)+"");	
				}
				else if(secondm=="Megahertz")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1E+6)+"");	
				}
				else if(secondm=="Gigahertz")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1e+9)+"");	
				}
			}
			else if(firstm=="Kilohertz")
			{
				if(secondm=="Hertz")
				{
					Double number=Double.parseDouble(l1.getText());
