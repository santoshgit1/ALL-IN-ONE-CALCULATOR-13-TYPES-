...
public class Length extends JFrame implements ActionListener,KeyListener
{
	...
	public Length() {
		...
		buttonborder=BorderFactory.createLineBorder(Color.black,1);
		 activebuttonborder=BorderFactory.createLineBorder(howercolor,2);
			...
			combo1.setModel(new DefaultComboBoxModel(new String[] {"Nanometers", "Micrometers", "Milimeters", "Centimeters", "Meters", "Kilometers", "Inches", "Feet", "Yards", "Miles","Nautical Miles"}));
			combo1.setSelectedIndex(3);
			combo1.setFocusable(false);
			combo1.setForeground(Color.BLACK);
			combo1.setBackground(Color.WHITE);
			combo1.setBounds(16, 192, 144, 25);
			contentPane.add(combo1);
	
			
			 combo2 = new JComboBox();
			 combo2.setMaximumRowCount(11);
			combo2.setFont(new Font("Square721 BT", Font.PLAIN, 15));
			combo2.setModel(new DefaultComboBoxModel(new String[] {"Nanometers", "Micrometers", "Milimeters", "Centimeters", "Meters", "Kilometers", "Inches", "Feet", "Yards", "Miles","Nautical Miles"}));
			...
			lblNewLabel.setBounds(200, 190, 80, 22);
	...
	public void docalc()
	{
		...
		if(firstm=="Nanometers")
		{
				if( secondm=="Meters")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1000000000)+"");
				}
				else if(secondm=="Centimeters")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/10000000)+"");	
				}
				else if( secondm=="Micrometers")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/10000)+"");	
				}
				else if(secondm=="Milimeters")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1000000)+"");	
				}
				else if( secondm=="Kilometers")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1E+12)+"");	
				}
				else if( secondm=="Inches")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/2.54E+7)+"");	
				}
				else if( secondm=="Feet")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/3.048E+8)+"");	
				}
				else if( secondm=="Yards")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/9.144E+8)+"");	
				}
				else if(secondm=="Miles")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.609E+12)+"");	
				}
				else if(secondm=="Nautical Miles")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.852E+12)+"");	
				}
		}
		else if(firstm=="Micrometers")
		{
				if( secondm=="Meters")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/100000)+"");	
				}
				else if( secondm=="Nanometers")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1E+9)+"");	
				}
				else if( secondm=="Inches")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/25400)+"");	
				}
				else if( secondm=="Feet")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/304800)+"");	
				}
				else if( secondm=="Yards")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/914400)+"");	
				}
				else if(secondm=="Miles")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.609E+9)+"");	
				}
				else if(secondm=="Nautical Miles")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.852E+9)+"");	
				}
		}
		if(firstm=="Milimeters")
		{
				if( secondm=="Meters")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/25.4)+"");	
				}
				else if( secondm=="Feet")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/305)+"");	
				}
				else if( secondm=="Yards")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/914)+"");	
				}
				else if(secondm=="Miles")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.609E+6)+"");	
				}
				else if(secondm=="Nautical Miles")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.852E+6)+"");	
				}
		}
		
		else if(firstm=="Centimeters")
		{
				if( secondm=="Meters")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/100)+"");
				}
				else if(secondm=="Nanometers")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/2.54)+"");	
				}
				else if( secondm=="Feet")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/30.48)+"");	
				}
				else if( secondm=="Yards")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/91.44)+"");	
				}
				else if(secondm=="Miles")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/160934)+"");	
				}
				else if(secondm=="Nautical Miles")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/185200)+"");	
				}
		}
		if(firstm=="Meters")
		{
				if( secondm=="Nanometers")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1E+9)+"");
				}
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1.094)+"");	
				}
				else if(secondm=="Miles")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1609)+"");	
				}
				else if(secondm=="Nautical Miles")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1852)+"");	
				}
		}
		else if(firstm=="Kilometers")
		{
				if( secondm=="Meters")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*39370)+"");	
				}
				else if( secondm=="Feet")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*3281)+"");	
				}
				else if( secondm=="Yards")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1094)+"");	
				}
				else if(secondm=="Miles")
				{
					Double number=Double.parseDouble(l1.getText());
		...
		else if(firstm=="Inches")
		{
			...
			{
				Double number=Double.parseDouble(l1.getText());
				l2.setText((number/12)+"");	
			}
			else if( secondm=="Yards")
			{
				Double number=Double.parseDouble(l1.getText());
				l2.setText((number/36)+"");	
			}
			else if(secondm=="Miles")
			{
				Double number=Double.parseDouble(l1.getText());
				l2.setText((number/63360)+"");	
			}
			else if(secondm=="Nautical Miles")
			{
				Double number=Double.parseDouble(l1.getText());
				l2.setText((number/72913)+"");	
			}
		}
		else if(firstm=="Feet")
		{
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/5280)+"");	
				}
				else if(secondm=="Nautical Miles")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/6076)+"");	
				}
		}
		else if(firstm=="Yards")
		{
				if( secondm=="Meters")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/2025)+"");	
				}
		}
		else if(firstm=="Miles")
		{
				if( secondm=="Meters")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1609.34)+"");
				}
				else if(secondm=="Centimeters")
				{
					Double number=Double.parseDouble(l1.getText());
