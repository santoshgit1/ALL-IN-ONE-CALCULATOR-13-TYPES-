...
public class Area extends JFrame implements ActionListener ,KeyListener
{
	...
	public Area() {
		...
		buttonborder=BorderFactory.createLineBorder(Color.black,1);
		 activebuttonborder=BorderFactory.createLineBorder(howercolor,2);
			...
			combo1.setModel(new DefaultComboBoxModel(new String[] {"Square kilometre", "Square metre", "Square mile", "Square yard", "Square foot", "Square inch", "Hectare", "Acre"}));
			...
			combo2.setModel(new DefaultComboBoxModel(new String[] {"Square kilometre", "Square metre", "Square mile", "Square yard", "Square foot", "Square inch", "Hectare", "Acre"}));
	...
	public void docalc()
	{
		...
		String secondm=(String) combo2.getSelectedItem();
			...
			if(firstm=="Square kilometre")
			{
				if(secondm=="Square kilometre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText(number+"");	
				}
				
				else if(secondm=="Square metre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1E+6)+"");	
				}
				else if(secondm=="Square mile")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/2.59)+"");	
				}
				else if(secondm=="Square yard")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1.196e+6)+"");	
				}
				else if(secondm=="Square foot")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1.076e+7)+"");	
				}
				else if(secondm=="Square inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1.55e+9)+"");	
				}
				else if(secondm=="Hectare")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*100)+"");	
				}
				else if(secondm=="Acre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*247.105)+"");	
				}
				
			}
			else if(firstm=="Square metre")
			{
				if(secondm=="Square kilometre")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/2.59e+6)+"");	
				}
				else if(secondm=="Square yard")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1.196)+"");	
				}
				else if(secondm=="Square foot")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*10.764)+"");	
				}
				else if(secondm=="Square inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1550)+"");	
				}
				else if(secondm=="Hectare")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/4047)+"");	
				}
				
			}
			else if(firstm=="Square mile")
			{
				if(secondm=="Square kilometre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*2.58999)+"");	
				}
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*3.098e+6)+"");	
				}
				else if(secondm=="Square foot")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*2.788e+7)+"");	
				}
				else if(secondm=="Square inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*4.014e+9)+"");	
				}
				else if(secondm=="Hectare")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*259)+"");	
				}
				else if(secondm=="Acre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*640)+"");	
				}
				
			}
			else if(firstm=="Square yard")
			{
				if(secondm=="Square kilometre")
				{
					Double number=Double.parseDouble(l1.getText());
			...
			else if(firstm=="Square foot")
			{
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*144)+"");	
				}
				else if(secondm=="Hectare")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/107639)+"");	
				}
				else if(secondm=="Acre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/43560)+"");	
				}
				
			}
			else if(firstm=="Square inch")
			{
				if(secondm=="Square kilometre")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.55e+7)+"");	
				}
				else if(secondm=="Acre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/6.273e+6)+"");	
				}
				
			}
			else if(firstm=="Hectare")
			{
				if(secondm=="Square kilometre")
				{
					Double number=Double.parseDouble(l1.getText());
