...
public class Pressure extends JFrame  implements ActionListener , KeyListener
{
	...
	public Pressure() {
		...
		buttonborder=BorderFactory.createLineBorder(Color.black,1);
		 activebuttonborder=BorderFactory.createLineBorder(howercolor,2);
			...
			combo1.setModel(new DefaultComboBoxModel(new String[] {"Bar", "Pascal", "Pound-force per square inch", "Standard atmosphere", "Torr"}));
			...
			combo2.setModel(new DefaultComboBoxModel(new String[] {"Bar", "Pascal", "Pound-force per square inch", "Standard atmosphere", "Torr"}));
	...
	public void docalc()
	{
		...
		String secondm=(String) combo2.getSelectedItem();
			...
			if(firstm=="Bar")
			{
				...
				else if(secondm=="Pascal")
				{

					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*100000)+"");
				}
				else if(secondm=="Pound-force per square inch")
				{

					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*14.5038)+"");
				}
				else if(secondm=="Standard atmosphere")
				{

					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.1013)+"");
				}
				else if(secondm=="Torr")
				{

					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*750)+"");
				}
			}
			else if(firstm=="Pascal")
			{
				if(secondm=="Bar")
				{
				...
				else if(secondm=="Pound-force per square inch")
				{
					...
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/6895)+"");
				}
				else if(secondm=="Standard atmosphere")
				{

					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/101325)+"");
				}
				else if(secondm=="Torr")
				{

					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/133)+"");
				}
			}
			else if(firstm=="Pound-force per square inch")
			{
				if(secondm=="Bar")
				{

					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/14.504)+"");
				}
				else if(secondm=="Pascal")
				{
				...
				else if(secondm=="Standard atmosphere")
				{
					...
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/14.696)+"");
				}
				else if(secondm=="Torr")
				{

					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*51.715)+"");
				}
			}

			else if(firstm=="Standard atmosphere")
			{
				if(secondm=="Bar")
				{

					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1.01325)+"");
				}
				else if(secondm=="Pascal")
				{
