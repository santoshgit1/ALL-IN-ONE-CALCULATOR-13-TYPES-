...
public class Volume extends JFrame implements ActionListener, KeyListener
{
	...
	public Volume() {
		...
		buttonborder=BorderFactory.createLineBorder(Color.black,1);
		 activebuttonborder=BorderFactory.createLineBorder(howercolor,2);
			...
			combo1.setModel(new DefaultComboBoxModel(new String[] {"US liquid gallon", "US liquid quart", "US liquid pint", "US legal cup", "Fluid ounce", "US tablespoon", "US teaspoon", "Cubic metre", "Litre", "Millilitre", "Gallon", "Imperial quart", "Imperial pint", "Imperial cup", "Imperial tablespoon", "Imperial teaspoon", "Cubic foot", "Cubic inch"}));
			combo1.setSelectedIndex(0);
			combo1.setFocusable(false);
			combo1.setForeground(Color.BLACK);
			combo1.setBackground(Color.WHITE);
			combo1.setBounds(16, 192, 179, 25);
			contentPane.add(combo1);
	
			
			 combo2 = new JComboBox();
			 combo2.setMaximumRowCount(10);
			combo2.setFont(new Font("Square721 BT", Font.PLAIN, 15));
			combo2.setModel(new DefaultComboBoxModel(new String[] {"US liquid gallon", "US liquid quart", "US liquid pint", "US legal cup", "Fluid ounce", "US tablespoon", "US teaspoon", "Cubic metre", "Litre", "Millilitre", "Gallon", "Imperial quart", "Imperial pint", "Imperial cup", "Imperial tablespoon", "Imperial teaspoon", "Cubic foot", "Cubic inch"}));
			combo2.setForeground(Color.BLACK);
			combo2.setSelectedIndex(1);
			combo2.setFocusable(false);
			combo2.setBackground(Color.WHITE);
			combo2.setBounds(267, 192, 179, 25);
	...
	public void docalc()
	{
		...
		String secondm=(String) combo2.getSelectedItem();
			...
			if(firstm=="US liquid gallon")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
					
					l2.setText((number)+"");	
				}
				else if(secondm=="US liquid quart")
					
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*4)+"");	
				}
				else if(secondm=="US liquid pint")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*8)+"");	
				}
				else if(secondm=="US legal cup")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*15.7725)+"");	
				}
				else if(secondm=="Fluid ounce")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*128)+"");	
				}
				
				else if(secondm=="US tablespoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*256)+"");	
				}
				else if(secondm=="US teaspoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*768)+"");	
				}
				else if(secondm=="Cubic metre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/264)+"");	
				}
				else if(secondm=="Litre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*3.78541)+"");	
				}
				else if(secondm=="Millilitre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*3785.41)+"");	
				}
				else if(secondm=="Gallon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.201)+"");	
				}
				else if(secondm=="Imperial quart")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*3.3307)+"");	
				}
				else if(secondm=="Imperial pint")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*6.661)+"");	
				}
				else if(secondm=="Imperial cup")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*13.323)+"");	
				}
				else if(secondm=="Imperial tablespoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*213.165)+"");	
				}
				else if(secondm=="Imperial teaspoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*639.494)+"");	
				}
				else if(secondm=="Cubic foot")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/7.481)+"");	
				}
				else if(secondm=="Cubic inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*231)+"");	
				}
				
			}
			else if(firstm=="US liquid quart")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*3.943)+"");	
				}
				else if(secondm=="Fluid ounce")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*32)+"");	
				}
				
				else if(secondm=="US tablespoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*64)+"");	
				}
				else if(secondm=="US teaspoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*192)+"");	
				}
				else if(secondm=="Cubic metre")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.057)+"");	
				}
				else if(secondm=="Millilitre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*946.353)+"");	
				}
				else if(secondm=="Gallon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/4.804)+"");	
				}
				else if(secondm=="Imperial quart")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*53.2911)+"");	
				}
				else if(secondm=="Imperial teaspoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*159.873)+"");	
				}
				else if(secondm=="Cubic foot")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/29.922)+"");	
				}
				else if(secondm=="Cubic inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*57.75)+"");	
				}
				
			}		
			else if(firstm=="US liquid pint")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1.972)+"");	
				}
				else if(secondm=="Fluid ounce")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*16)+"");	
				}
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*96)+"");	
				}
				else if(secondm=="Cubic metre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/2113)+"");	
				}
				else if(secondm=="Litre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*2.113)+"");	
				}
				else if(secondm=="Millilitre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*473)+"");	
				}
				else if(secondm=="Gallon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/9.608)+"");	
				}
				else if(secondm=="Imperial quart")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/2.402)+"");	
				}
				else if(secondm=="Imperial pint")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1.665)+"");	
				}
				else if(secondm=="Imperial tablespoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*26.646)+"");	
				}
				else if(secondm=="Imperial teaspoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*79.937)+"");	
				}
				else if(secondm=="Cubic foot")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/59.844)+"");	
				}
				else if(secondm=="Cubic inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*28.875)+"");	
				}
				
			}
			else if(firstm=="US legal cup")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
					
					l2.setText((number/15.773)+"");	
				}
				else if(secondm=="US liquid quart")
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*8.11537)+"");	
				}
				
				else if(secondm=="US tablespoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*16.2307)+"");	
				}
				else if(secondm=="US teaspoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*48.6922)+"");	
				}
				else if(secondm=="Cubic metre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/4167)+"");	
				}
				else if(secondm=="Litre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/4.167)+"");	
				}
				else if(secondm=="Millilitre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*240)+"");	
				}
				else if(secondm=="Gallon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/18.942)+"");	
				}
				else if(secondm=="Imperial quart")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/4.736)+"");	
				}
				else if(secondm=="Imperial pint")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/2.368)+"");	
				}
				else if(secondm=="Imperial cup")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.184)+"");	
				}
				else if(secondm=="Imperial tablespoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*13.515)+"");	
				}
				else if(secondm=="Imperial teaspoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*40.545)+"");	
				}
				else if(secondm=="Cubic foot")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/118)+"");	
				}
				else if(secondm=="Cubic inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*14.646)+"");	
				}
				
			}
			else if(firstm=="Fluid ounce")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/33814)+"");	
				}
				else if(secondm=="Litre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/33.814)+"");	
				}
				else if(secondm=="Millilitre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*29.574)+"");	
				}
				else if(secondm=="Gallon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/154)+"");	
				}
				else if(secondm=="Imperial quart")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/38.43)+"");	
				}
				else if(secondm=="Imperial pint")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/19.215)+"");	
				}
				else if(secondm=="Imperial cup")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*4.99604)+"");	
				}
				else if(secondm=="Cubic foot")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/958)+"");	
				}
				else if(secondm=="Cubic inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1.805)+"");	
				}
				
			}
			else if(firstm=="US tablespoon")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/67628)+"");	
				}
				else if(secondm=="Litre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/67.628)+"");	
				}
				else if(secondm=="Millilitre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*14.787)+"");	
				}
				else if(secondm=="Gallon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/307)+"");	
				}
				else if(secondm=="Imperial quart")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/76.861)+"");	
				}
				else if(secondm=="Imperial pint")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*2.498)+"");	
				}
				else if(secondm=="Cubic foot")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1915)+"");	
				}
				else if(secondm=="Cubic inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.108)+"");	
				}
				
			}
			else if(firstm=="US teaspoon")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/202884)+"");	
				}
				else if(secondm=="Litre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/203)+"");	
				}
				else if(secondm=="Millilitre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*4.929)+"");	
				}
				else if(secondm=="Gallon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/922)+"");	
				}
				else if(secondm=="Imperial quart")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/115)+"");	
				}
				else if(secondm=="Imperial cup")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*57.646)+"");	
				}
				else if(secondm=="Imperial tablespoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/3.603)+"");	
				}
				else if(secondm=="Imperial teaspoon")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/5745)+"");	
				}
				else if(secondm=="Cubic inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/3.325)+"");	
				}
				
			}
			else if(firstm=="Cubic metre")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
					
					l2.setText((number*264.172)+"");	
				}
				else if(secondm=="US liquid quart")
					
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1056.69)+"");	
				}
				else if(secondm=="US liquid pint")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*2113.38)+"");	
				}
				else if(secondm=="US legal cup")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*4166.67)+"");	
				}
				else if(secondm=="Fluid ounce")
				{
					Double number=Double.parseDouble(l1.getText());
			...
			else if(firstm=="Cubic metre")
			{
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1000)+"");	
				}
				else if(secondm=="Millilitre")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1e+6)+"");	
				}
				else if(secondm=="Gallon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*220)+"");	
				}
				else if(secondm=="Imperial quart")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*880)+"");	
				}
				else if(secondm=="Imperial pint")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1760)+"");	
				}
				else if(secondm=="Imperial cup")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*3520)+"");	
				}
				else if(secondm=="Imperial tablespoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*56312)+"");	
				}
				else if(secondm=="Imperial teaspoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*168936)+"");	
				}
				else if(secondm=="Cubic foot")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*35.315)+"");	
				}
				else if(secondm=="Cubic inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*61023.7)+"");	
				}
				
			}
			else if(firstm=="Litre")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
					
					l2.setText((number/3.785)+"");	
				}
				else if(secondm=="US liquid quart")
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/4.546)+"");	
				}
				else if(secondm=="Imperial quart")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.137)+"");	
				}
				else if(secondm=="Imperial pint")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1.76)+"");	
				}
				else if(secondm=="Imperial cup")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*3.52)+"");	
				}
				else if(secondm=="Imperial tablespoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*56.312)+"");	
				}
				else if(secondm=="Imperial teaspoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*169)+"");	
				}
				else if(secondm=="Cubic foot")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/28.317)+"");	
				}
				else if(secondm=="Cubic inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*61.024)+"");	
				}
				
			}
			else if(firstm=="Millilitre")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
					
					l2.setText((number/3785)+"");	
				}
				else if(secondm=="US liquid quart")
					
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/946)+"");	
				}
				else if(secondm=="US liquid pint")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/4546)+"");	
				}
				else if(secondm=="Imperial quart")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1137)+"");	
				}
				else if(secondm=="Imperial pint")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/568)+"");	
				}
				else if(secondm=="Imperial cup")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/284)+"");	
				}
				else if(secondm=="Imperial tablespoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/17.758)+"");	
				}
				else if(secondm=="Imperial teaspoon")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/5.919)+"");	
				}
				else if(secondm=="Cubic foot")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/28317)+"");	
				}
				else if(secondm=="Cubic inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/16.387)+"");	
				}
				
			}
			else if(firstm=="Gallon")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/6.229)+"");	
				}
				else if(secondm=="Cubic inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*277)+"");	
				}
				
			}
			else if(firstm=="Imperial quart")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
					
					l2.setText((number/3.331)+"");	
				}
				else if(secondm=="US liquid quart")
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/24.915)+"");	
				}
				else if(secondm=="Cubic inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*69.355)+"");	
				}
				
			}
			else if(firstm=="Imperial pint")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/49.831)+"");	
				}
				else if(secondm=="Cubic inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*34.677)+"");	
				}
				
			}
			else if(firstm=="Imperial cup")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*48)+"");	
				}
				else if(secondm=="Cubic foot")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/99.661)+"");	
				}
				else if(secondm=="Cubic inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*17.339)+"");	
				}
				
			}
			else if(firstm=="Imperial tablespoon")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
					
					l2.setText((number/213)+"");	
				}
				else if(secondm=="US liquid quart")
					
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/53.291)+"");	
				}
				else if(secondm=="US liquid pint")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1595)+"");	
				}
				else if(secondm=="Cubic inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1.084)+"");	
				}
				
			}
			else if(firstm=="Imperial teaspoon")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
					
					l2.setText((number/639)+"");	
				}
				else if(secondm=="US liquid quart")
					
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/160)+"");	
				}
				else if(secondm=="US liquid pint")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/4784)+"");	
				}
				else if(secondm=="Cubic inch")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/2.768)+"");	
				}
				
			}
			else if(firstm=="Cubic foot")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1728)+"");	
				}
				
			}
			else if(firstm=="Cubic inch")
			{
				if(secondm=="US liquid gallon")
				{
					Double number=Double.parseDouble(l1.getText());
	...
	public void menubar()
	{
		...
		mnFile.add(masscalc);
		 ...
		 follow.setBackground(Color.WHITE);
			...
			normalcalc.setIcon(new ImageIcon("CALC_IMG\\calculator.png"));
			standardcalc.setIcon(new ImageIcon("CALC_IMG\\standardcalculator.png"));
			scintificcalc.setIcon(new ImageIcon("CALC_IMG\\scintificcalculator.png"));
			lengthcalc.setIcon(new ImageIcon("CALC_IMG\\length.png"));
			tempcalc.setIcon(new ImageIcon("CALC_IMG\\temperature.png"));
			energycalc.setIcon(new ImageIcon("CALC_IMG\\energy.png"));
			areacalc.setIcon(new ImageIcon("CALC_IMG\\area.png"));
			speedcalc.setIcon(new ImageIcon("CALC_IMG\\speed.png"));
			pressurecalc.setIcon(new ImageIcon("CALC_IMG\\pressure.png"));
			anglecalc.setIcon(new ImageIcon("CALC_IMG\\angle.png"));
			frequencycalc.setIcon(new ImageIcon("CALC_IMG\\frequency.png"));
			volumecalc.setIcon(new ImageIcon("CALC_IMG\\volume.png"));
			masscalc.setIcon(new ImageIcon("CALC_IMG\\mass.png"));
			instagram.setIcon(new ImageIcon("CALC_IMG\\instagram.png"));
			facebook.setIcon(new ImageIcon("CALC_IMG\\facebook.png"));
			github.setIcon(new ImageIcon("CALC_IMG\\github.png"));
			follow.setIcon(new ImageIcon("CALC_IMG\\followme.png"));
	...
	public void menubaractionlistener(Object source)
	{
		...
		{
			StringBuffer url=new StringBuffer("https://www.instagram.com/santoshlucky007/");
		...
		{
			StringBuffer url=new StringBuffer("https://www.facebook.com/santosh.rock.351");
			Desktop desktop=Desktop.getDesktop();
			try
			{
			desktop.browse(URI.create(url.toString()));
		...
		{
			StringBuffer url=new StringBuffer("https://github.com/Creator032");
			Desktop desktop=Desktop.getDesktop();
			try
			{
			desktop.browse(URI.create(url.toString()));
