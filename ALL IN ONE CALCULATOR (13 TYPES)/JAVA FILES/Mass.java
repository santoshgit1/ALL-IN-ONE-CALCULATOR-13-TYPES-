...
public class Mass extends JFrame implements ActionListener , KeyListener
{
	...
	private JLabel converterlbl;
	private JLabel calculatorlbl;
	private JButton b1;
	private JButton b2;
	private JButton b3;
	private JButton b4;
	...
	public Mass() {
		...
		buttonborder=BorderFactory.createLineBorder(Color.black,1);
		 activebuttonborder=BorderFactory.createLineBorder(howercolor,2);
			...
			combo1.setModel(new DefaultComboBoxModel(new String[] {"Tonne", "Kilogram", "Gram", "Milligram", "Microgram", "Imperial ton", "US ton", "Stone", "Pound", "Ounce"}));
			...
			combo2.setModel(new DefaultComboBoxModel(new String[] {"Tonne", "Kilogram", "Gram", "Milligram", "Microgram", "Imperial ton", "US ton", "Stone", "Pound", "Ounce"}));
	...
	public void docalc()
	{
		...
		String secondm=(String) combo2.getSelectedItem();
			...
			if(firstm=="Tonne")
			{
				...
				else if(secondm=="Kilogram")
					
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1000)+"");	
				}
				else if(secondm=="Gram")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1E+6)+"");	
				}
				else if(secondm=="Milligram")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1e+9)+"");	
				}
				else if(secondm=="Microgram")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1e+12)+"");	
				}
				else if(secondm=="Imperial ton")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.016)+"");	
				}
				else if(secondm=="US ton")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1.102)+"");	
				}
				else if(secondm=="Stone")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*157.473)+"");	
				}
				else if(secondm=="Pound")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*2204.62)+"");	
				}
				else if(secondm=="Ounce")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*35274)+"");	
				}
			}
			else if(firstm=="Kilogram")
			{
				if(secondm=="Tonne")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1016)+"");	
				}
				else if(secondm=="US ton")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/907)+"");	
				}
				else if(secondm=="Stone")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/6.35)+"");	
				}
				else if(secondm=="Pound")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*2.20462)+"");	
				}
				else if(secondm=="Ounce")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*35.274)+"");	
				}
			}
			...
			else if(firstm=="Gram")
			{
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.016e+6)+"");	
				}
				else if(secondm=="US ton")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/907185)+"");	
				}
				else if(secondm=="Stone")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/6350)+"");	
				}
				else if(secondm=="Pound")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/454)+"");	
				}
				else if(secondm=="Ounce")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/28.35)+"");	
				}
			}
			else if(firstm=="Milligram")
			{
				if(secondm=="Tonne")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.016e+9)+"");	
				}
				else if(secondm=="US ton")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/9.072e+8)+"");	
				}
				else if(secondm=="Stone")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/6.35e+6)+"");	
				}
				else if(secondm=="Pound")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/453592)+"");	
				}
				else if(secondm=="Ounce")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/28350)+"");	
				}
			}
			else if(firstm=="Microgram")
			{
				if(secondm=="Tonne")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.1016e+12)+"");	
				}
				else if(secondm=="US ton")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/9.072e+11)+"");	
				}
				else if(secondm=="Stone")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/6.35e+9)+"");	
				}
				else if(secondm=="Pound")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/4.536e+8)+"");	
				}
				else if(secondm=="Ounce")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/2.835e+7)+"");	
				}
			}
			else if(firstm=="Imperial ton")
			{
				if(secondm=="Tonne")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*2240)+"");	
				}
				else if(secondm=="Ounce")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*35840)+"");	
				}
			}
			else if(firstm=="US ton")
			{
				if(secondm=="Tonne")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*143)+"");	
				}
				else if(secondm=="Pound")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*2000)+"");	
					
				}
				else if(secondm=="Ounce")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*32000)+"");	
				}
			}
			else if(firstm=="Stone")
			{
				if(secondm=="Tonne")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/157)+"");	
				}
				else if(secondm=="Kilogram")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*14)+"");	
					
				}
				else if(secondm=="Ounce")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*224)+"");	
				}
			}
			else if(firstm=="Pound")
			{
				if(secondm=="Tonne")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/2205)+"");	
				}
				else if(secondm=="Kilogram")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/2.205)+"");	
				}
				else if(secondm=="Gram")
				{
					Double number=Double.parseDouble(l1.getText());
