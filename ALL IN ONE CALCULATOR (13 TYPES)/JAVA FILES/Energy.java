...
public class Energy extends JFrame implements ActionListener,KeyListener
{


	private JPanel contentPane;
	private JMenuItem normalcalc,standardcalc,scintificcalc,lengthcalc,tempcalc,energycalc,areacalc,speedcalc,pressurecalc,anglecalc,frequencycalc,volumecalc,masscalc;
	...
	public Energy() {
		...
		buttonborder=BorderFactory.createLineBorder(Color.black,1);
		 activebuttonborder=BorderFactory.createLineBorder(howercolor,2);
			...
			combo1.setModel(new DefaultComboBoxModel(new String[] {"Joule", "Kilojoule", "Gram calorie", "Kilocalorie", "Watt hour", "Kilowatt hour", "Electronvolt", "British thermal unit", "US therm", "Foot-pound"}));
			...
			combo2.setModel(new DefaultComboBoxModel(new String[] {"Joule", "Kilojoule", "Gram calorie", "Kilocalorie", "Watt hour", "Kilowatt hour", "Electronvolt", "British thermal unit", "US therm", "Foot-pound"}));
	...
	public void docalc()
	{
		...
		String secondm=(String) combo2.getSelectedItem();
			...
			if(firstm=="Joule")
			{
				...
				if(secondm=="Kilojoule")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText(number/1000+"");
				}
				else if(secondm=="Gram calorie")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText(number/4.184+"");
				}
				else if(secondm=="Kilocalorie")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText(number/4184+"");
				}
				else if(secondm=="Watt hour")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText(number/3600+"");
				}
				else if(secondm=="Kilowatt hour")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/3.6E+6)+"");
				}
				else if(secondm=="Electronvolt")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*6.242E+18)+"");
				}
				else if(secondm=="British thermal unit")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*1055)+"");
				}
				else if(secondm=="US therm")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.055E+8)+"");
				}
				else if(secondm=="Foot-pound")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.356)+"");
				}
				
			}
			else	if(firstm=="Kilojoule")
			{
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*6.242E+21)+"");
				}
				else if(secondm=="British thermal unit")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/1.055)+"");
				}
				else if(secondm=="US therm")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/105480)+"");
				}
				else if(secondm=="Foot-pound")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*737.562)+"");
				}
				
			} 
			else if(firstm=="Gram calorie")
			{
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText(number/860+"");
				}
				else if(secondm=="Kilowatt hour")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/860421)+"");
				}
				else if(secondm=="Electronvolt")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*2.611E+19)+"");
				}
				else if(secondm=="British thermal unit")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/252)+"");
				}
				else if(secondm=="US therm")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/2.521E+7)+"");
				}
				else if(secondm=="Foot-pound")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*3.086)+"");
				}
				
			} 
			
			else	if(firstm=="Kilocaloie")
			{
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*9.223E+18)+"");
				}
				else if(secondm=="British thermal unit")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*3.966)+"");
				}
				else if(secondm=="US therm")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/25210)+"");
				}
				else if(secondm=="Foot-pound")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*3085.96)+"");
				}
				
			} 
			else	if(firstm=="Watt hour")
			{
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*2.247E+22)+"");
				}
				else if(secondm=="British thermal unit")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*3.41214)+"");
				}
				else if(secondm=="US therm")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/29300)+"");
				}
				else if(secondm=="Foot-pound")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*2655)+"");
				}
				
			} 
			else	if(firstm=="Kilowatt hour")
			{
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*2.247E+25)+"");
				}
				else if(secondm=="British thermal unit")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*3412.14)+"");
				}
				else if(secondm=="US therm")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/29.3)+"");
				}
				else if(secondm=="Foot-pound")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*2.655E+6)+"");
				}
				
			} 
			else	if(firstm=="Electronvolt")
			{
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*2.247E+19)+"");
				}
				else if(secondm=="British thermal unit")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/6.585E+21)+"");
				}
				else if(secondm=="US therm")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/6.584E+26)+"");
				}
				else if(secondm=="Foot-pound")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/8.462E+18)+"");
				}
				
			} 
			else	if(firstm=="British thermal unit")
			{
				
				if(secondm=="Joule")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText(number*1055.06+"");
				}
				else if(secondm=="Gram calorie")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number/99976)+"");
				}
				else if(secondm=="Foot-pound")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*778)+"");
				}
				
			} 
			else	if(firstm=="US therm")
			{
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*7.78E+7)+"");
				}
				
			} 
			else	if(firstm=="Foot-pound")
			{
				
				if(secondm=="Joule")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText(number*1.35582+"");
				}
				else if(secondm=="Gram calorie")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText(number/738+"");
				}
				else if(secondm=="Kilo calorie")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText(number/3086+"");
				}
				else if(secondm=="Kilowatt hour")
				{
					Double number=Double.parseDouble(l1.getText());
