...
public class Angle extends JFrame implements ActionListener,KeyListener
{
	...
	public Angle() {
		...
		buttonborder=BorderFactory.createLineBorder(Color.black,1);
		 activebuttonborder=BorderFactory.createLineBorder(howercolor,2);
			...
			combo1.setModel(new DefaultComboBoxModel(new String[] {"Degree", "Radian", "Gradian"}));
			...
			combo2.setModel(new DefaultComboBoxModel(new String[] {"Degree", "Radian", "Gradian"}));
	...
	public void docalc()
	{
		...
		String secondm=(String) combo2.getSelectedItem();
			...
			if(firstm=="Degree")
			{
				...
				else if(secondm=="Radian")
				{
					Double number=Double.parseDouble(l1.getText());
					number=Math.toRadians(number);
					l2.setText((number)+"");	
				}
				else if(secondm=="Gradian")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*200/180)+"");	
				}
			}
			else if(firstm=="Radian")
			{
				if(secondm=="Degree")
				{
					Double number=Double.parseDouble(l1.getText());
				...
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*200/Math.PI)+"");	
				}
			}
			else if(firstm=="Gradian")
			{
				if(secondm=="Degree")
				{
					Double number=Double.parseDouble(l1.getText());
					
					l2.setText((number*180/200)+"");	
				}
				else if(secondm=="Radian")
				{
					Double number=Double.parseDouble(l1.getText());
					l2.setText((number*(Math.PI/200))+"");	
				}
				else if(secondm=="Gradian")
				{
					Double number=Double.parseDouble(l1.getText());
